...
import type { GetGetCurrentUserData, GetGetCurrentUserResponse, GetGetCurrentUserError, GetGetUserByIdData, GetGetUserByIdResponse, GetGetUserByIdError, PostUpdateUserByIdData, PostUpdateUserByIdResponse, PostUpdateUserByIdError, GetGetGroupsData, GetGetGroupsResponse, GetGetGroupsError, GetGetGroupByIdData, GetGetGroupByIdResponse, GetGetGroupByIdError, PostCreateGroupData, PostCreateGroupResponse, PostCreateGroupError, PostDeleteGroupByIdData, PostDeleteGroupByIdResponse, PostDeleteGroupByIdError, PostUndeleteGroupByIdData, PostUndeleteGroupByIdResponse, PostUndeleteGroupByIdError, PostAddUserToGroupData, PostAddUserToGroupResponse, PostRemoveUserFromGroupData, PostRemoveUserFromGroupResponse, GetGetFriendsData, GetGetFriendsResponse, GetGetFriendsError, GetGetFriendByIdData, GetGetFriendByIdResponse, GetGetFriendByIdError, PostCreateFriendData, PostCreateFriendResponse, PostCreateFriendError, PostCreateFriendsData, PostCreateFriendsResponse, PostCreateFriendsError, PostDeleteFriendByIdData, PostDeleteFriendByIdResponse, PostDeleteFriendByIdError, GetGetCurrenciesData, GetGetCurrenciesResponse, GetGetExpenseByIdData, GetGetExpenseByIdResponse, GetGetExpenseByIdError, GetGetExpensesData, GetGetExpensesResponse, GetGetExpensesError, PostCreateExpenseData, PostCreateExpenseResponse, PostCreateExpenseError, PostUpdateExpenseByIdData, PostUpdateExpenseByIdResponse, PostUpdateExpenseByIdError, PostDeleteExpenseByIdData, PostDeleteExpenseByIdResponse, PostDeleteExpenseByIdError, PostUndeleteExpenseByIdData, PostUndeleteExpenseByIdResponse, PostUndeleteExpenseByIdError, GetGetCommentsData, GetGetCommentsResponse, GetGetCommentsError, PostCreateCommentData, PostCreateCommentResponse, PostCreateCommentError, PostDeleteCommentByIdData, PostDeleteCommentByIdResponse, PostDeleteCommentByIdError, GetGetNotificationsData, GetGetNotificationsResponse, GetGetNotificationsError, GetGetCategoriesData, GetGetCategoriesResponse } from './types.gen';
...
export const getGetCurrentUser = <ThrowOnError extends boolean = false>(options?: Options<GetGetCurrentUserData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetGetCurrentUserResponse, GetGetCurrentUserError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getGetUserById = <ThrowOnError extends boolean = false>(options: Options<GetGetUserByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetGetUserByIdResponse, GetGetUserByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postUpdateUserById = <ThrowOnError extends boolean = false>(options: Options<PostUpdateUserByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostUpdateUserByIdResponse, PostUpdateUserByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getGetGroups = <ThrowOnError extends boolean = false>(options?: Options<GetGetGroupsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetGetGroupsResponse, GetGetGroupsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getGetGroupById = <ThrowOnError extends boolean = false>(options: Options<GetGetGroupByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetGetGroupByIdResponse, GetGetGroupByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postCreateGroup = <ThrowOnError extends boolean = false>(options: Options<PostCreateGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostCreateGroupResponse, PostCreateGroupError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postDeleteGroupById = <ThrowOnError extends boolean = false>(options: Options<PostDeleteGroupByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostDeleteGroupByIdResponse, PostDeleteGroupByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postUndeleteGroupById = <ThrowOnError extends boolean = false>(options: Options<PostUndeleteGroupByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostUndeleteGroupByIdResponse, PostUndeleteGroupByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postAddUserToGroup = <ThrowOnError extends boolean = false>(options: Options<PostAddUserToGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostAddUserToGroupResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postRemoveUserFromGroup = <ThrowOnError extends boolean = false>(options: Options<PostRemoveUserFromGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostRemoveUserFromGroupResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getGetFriends = <ThrowOnError extends boolean = false>(options?: Options<GetGetFriendsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetGetFriendsResponse, GetGetFriendsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getGetFriendById = <ThrowOnError extends boolean = false>(options: Options<GetGetFriendByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetGetFriendByIdResponse, GetGetFriendByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postCreateFriend = <ThrowOnError extends boolean = false>(options: Options<PostCreateFriendData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostCreateFriendResponse, PostCreateFriendError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postCreateFriends = <ThrowOnError extends boolean = false>(options: Options<PostCreateFriendsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostCreateFriendsResponse, PostCreateFriendsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postDeleteFriendById = <ThrowOnError extends boolean = false>(options: Options<PostDeleteFriendByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostDeleteFriendByIdResponse, PostDeleteFriendByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getGetCurrencies = <ThrowOnError extends boolean = false>(options?: Options<GetGetCurrenciesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetGetCurrenciesResponse, unknown, ThrowOnError>({
        url: '/get_currencies',
        ...options
    });
};
...
export const getGetExpenseById = <ThrowOnError extends boolean = false>(options: Options<GetGetExpenseByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetGetExpenseByIdResponse, GetGetExpenseByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getGetExpenses = <ThrowOnError extends boolean = false>(options?: Options<GetGetExpensesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetGetExpensesResponse, GetGetExpensesError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postUpdateExpenseById = <ThrowOnError extends boolean = false>(options: Options<PostUpdateExpenseByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostUpdateExpenseByIdResponse, PostUpdateExpenseByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postDeleteExpenseById = <ThrowOnError extends boolean = false>(options: Options<PostDeleteExpenseByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostDeleteExpenseByIdResponse, PostDeleteExpenseByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postUndeleteExpenseById = <ThrowOnError extends boolean = false>(options: Options<PostUndeleteExpenseByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostUndeleteExpenseByIdResponse, PostUndeleteExpenseByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getGetComments = <ThrowOnError extends boolean = false>(options: Options<GetGetCommentsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetGetCommentsResponse, GetGetCommentsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postCreateComment = <ThrowOnError extends boolean = false>(options: Options<PostCreateCommentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostCreateCommentResponse, PostCreateCommentError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postDeleteCommentById = <ThrowOnError extends boolean = false>(options: Options<PostDeleteCommentByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostDeleteCommentByIdResponse, PostDeleteCommentByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getGetNotifications = <ThrowOnError extends boolean = false>(options?: Options<GetGetNotificationsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetGetNotificationsResponse, GetGetNotificationsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getGetCategories = <ThrowOnError extends boolean = false>(options?: Options<GetGetCategoriesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetGetCategoriesResponse, unknown, ThrowOnError>({
        url: '/get_categories',
        ...options
    });
};