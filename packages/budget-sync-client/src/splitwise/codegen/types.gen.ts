...
export type NotificationSettingsi2 = NotificationSettings;
...
export type GetGetCurrentUserError =
	GetGetCurrentUserErrors[keyof GetGetCurrentUserErrors];
...
export type GetGetCurrentUserResponse =
	GetGetCurrentUserResponses[keyof GetGetCurrentUserResponses];
...
export type GetGetUserByIdError =
	GetGetUserByIdErrors[keyof GetGetUserByIdErrors];
...
export type GetGetUserByIdResponse =
	GetGetUserByIdResponses[keyof GetGetUserByIdResponses];
...
export type PostUpdateUserByIdError =
	PostUpdateUserByIdErrors[keyof PostUpdateUserByIdErrors];
...
export type PostUpdateUserByIdResponse =
	PostUpdateUserByIdResponses[keyof PostUpdateUserByIdResponses];
...
export type GetGetGroupsResponse =
	GetGetGroupsResponses[keyof GetGetGroupsResponses];
...
export type GetGetGroupByIdError =
	GetGetGroupByIdErrors[keyof GetGetGroupByIdErrors];
...
export type GetGetGroupByIdResponse =
	GetGetGroupByIdResponses[keyof GetGetGroupByIdResponses];
...
export type PostCreateGroupData = {
	body: {
		...
		[key: string]:
			| string
			| ("home" | "trip" | "couple" | "other" | "apartment" | "house")
			| boolean
			| undefined;
	};
	path?: never;
...
export type PostCreateGroupError =
	PostCreateGroupErrors[keyof PostCreateGroupErrors];
...
export type PostCreateGroupResponse =
	PostCreateGroupResponses[keyof PostCreateGroupResponses];
...
export type PostDeleteGroupByIdError =
	PostDeleteGroupByIdErrors[keyof PostDeleteGroupByIdErrors];
...
export type PostDeleteGroupByIdResponse =
	PostDeleteGroupByIdResponses[keyof PostDeleteGroupByIdResponses];
...
export type PostUndeleteGroupByIdError =
	PostUndeleteGroupByIdErrors[keyof PostUndeleteGroupByIdErrors];
...
export type PostUndeleteGroupByIdResponse =
	PostUndeleteGroupByIdResponses[keyof PostUndeleteGroupByIdResponses];
...
export type PostAddUserToGroupResponse =
	PostAddUserToGroupResponses[keyof PostAddUserToGroupResponses];
...
export type PostRemoveUserFromGroupResponse =
	PostRemoveUserFromGroupResponses[keyof PostRemoveUserFromGroupResponses];
...
export type GetGetFriendsResponse =
	GetGetFriendsResponses[keyof GetGetFriendsResponses];
...
export type GetGetFriendByIdError =
	GetGetFriendByIdErrors[keyof GetGetFriendByIdErrors];
...
export type GetGetFriendByIdResponse =
	GetGetFriendByIdResponses[keyof GetGetFriendByIdResponses];
...
export type PostCreateFriendError =
	PostCreateFriendErrors[keyof PostCreateFriendErrors];
...
export type PostCreateFriendResponse =
	PostCreateFriendResponses[keyof PostCreateFriendResponses];
...
export type PostCreateFriendsError =
	PostCreateFriendsErrors[keyof PostCreateFriendsErrors];
...
export type PostCreateFriendsResponse =
	PostCreateFriendsResponses[keyof PostCreateFriendsResponses];
...
export type PostDeleteFriendByIdError =
	PostDeleteFriendByIdErrors[keyof PostDeleteFriendByIdErrors];
...
export type PostDeleteFriendByIdResponse =
	PostDeleteFriendByIdResponses[keyof PostDeleteFriendByIdResponses];
...
export type GetGetCurrenciesResponse =
	GetGetCurrenciesResponses[keyof GetGetCurrenciesResponses];
...
export type GetGetExpenseByIdError =
	GetGetExpenseByIdErrors[keyof GetGetExpenseByIdErrors];
...
export type GetGetExpenseByIdResponse =
	GetGetExpenseByIdResponses[keyof GetGetExpenseByIdResponses];
...
export type GetGetExpensesError =
	GetGetExpensesErrors[keyof GetGetExpensesErrors];
...
export type GetGetExpensesResponse =
	GetGetExpensesResponses[keyof GetGetExpensesResponses];
...
export type PostUpdateExpenseByIdError =
	PostUpdateExpenseByIdErrors[keyof PostUpdateExpenseByIdErrors];
...
export type PostUpdateExpenseByIdResponse =
	PostUpdateExpenseByIdResponses[keyof PostUpdateExpenseByIdResponses];
...
export type PostDeleteExpenseByIdError =
	PostDeleteExpenseByIdErrors[keyof PostDeleteExpenseByIdErrors];
...
export type PostDeleteExpenseByIdResponse =
	PostDeleteExpenseByIdResponses[keyof PostDeleteExpenseByIdResponses];
...
export type PostUndeleteExpenseByIdError =
	PostUndeleteExpenseByIdErrors[keyof PostUndeleteExpenseByIdErrors];
...
export type PostUndeleteExpenseByIdResponse =
	PostUndeleteExpenseByIdResponses[keyof PostUndeleteExpenseByIdResponses];
...
export type GetGetCommentsError =
	GetGetCommentsErrors[keyof GetGetCommentsErrors];
...
export type GetGetCommentsResponse =
	GetGetCommentsResponses[keyof GetGetCommentsResponses];
...
export type PostCreateCommentError =
	PostCreateCommentErrors[keyof PostCreateCommentErrors];
...
export type PostCreateCommentResponse =
	PostCreateCommentResponses[keyof PostCreateCommentResponses];
...
export type PostDeleteCommentByIdError =
	PostDeleteCommentByIdErrors[keyof PostDeleteCommentByIdErrors];
...
export type PostDeleteCommentByIdResponse =
	PostDeleteCommentByIdResponses[keyof PostDeleteCommentByIdResponses];
...
export type GetGetNotificationsError =
	GetGetNotificationsErrors[keyof GetGetNotificationsErrors];
...
export type GetGetNotificationsResponse =
	GetGetNotificationsResponses[keyof GetGetNotificationsResponses];
...
export type GetGetCategoriesResponse =
	GetGetCategoriesResponses[keyof GetGetCategoriesResponses];
